...
- :wave: Away from OI
- :zap: Use zsh ([config](https://github.com/ForkKILLET/FkHome/blob/M/.zshrc)) · vim ([config](https://github.com/ForkKILLET/FkVim)) · NixOS ([config](https://github.com/ForkKILLET/FkHome/blob/M/nixos))
- :house: [Homepage](https://icelava.top) · [Segment Fault](https://segmentfault.com/u/forkkillet) · [Bilibili](https://space.bilibili.com/652340629) · [Zhihu](https://www.zhihu.com/people/forkkillet)
